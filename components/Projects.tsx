  ...
  const projects = [
    {
      id: '1',
      image:
        'https://lh3.googleusercontent.com/pw/AMWts8BdtYLDfS1CDJP56tKpagwBqZ8TJ9H0QcLvBrNN9FiQy6ycP72jlOLVsO2b1zINQ82jCVhB3xdfOWps7DbZoN1RMpJYyWM9ibNSl_1URj9MwRDNUyPRq3PsU_3phfmCzoYzieP_Kpz6b8nUqI296oRO=w1123-h778-no?authuser=0',
      title: 'Ресторан Your Meal',
      technologies: [
      ...
      description:
        'Веб-приложение ресторан на React. Реализован следующий функционал: добавление товара, изменение кол-ва товара, отправка формы данных на сервер. Cостояние приложения реализовано через Redux Toolkit. API товаров подтягиваются с сервера Glitch. Стили реализованы через CSS Modules.',
      link: 'https://burger-react-psi.vercel.app/',
      gitLink: 'https://github.com/kyoto430/burger-react',
    },
    {
      id: '2',
      image:
