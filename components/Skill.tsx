  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        src={skill.logo}
        alt=""
        className="rounded-full border border-gray-500 object-contain w-16 h-16 md:w-24 md:h-24 xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
