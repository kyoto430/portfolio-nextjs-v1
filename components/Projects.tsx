  ...
  const projects = [
    {
      ...
      description:
        'Адаптивная вёрстка страниц для сайта. Реализован следующий интерфейс: 2 слайдера (1 для моб.версии), меню-бургер, модальные окна, пагинация, хлебные-крошки, увеличение картинок при нажатии, элементы "раскрыть/скрыть". Реализован адаптивный дизайн под мобильные устройства.',
    ...
    },
    {
      id: '4',
      image:
        'https://lh3.googleusercontent.com/pw/ADCreHfLtSwqGpp2uGuAu72lslG-wzo6FOf1v9Cwr8MldLBuMGK4XZ4Jg3icPF6RxDe28Wir8JwO8WFp6JCnoHf2fMl1YJI6kCCQteJBDJlk10kUa6VIlzdW4rsyLYYVuq3RJEXBaC8wp8IdwF3QHw5eOzML=w957-h663-s-no?authuser=0',
      title: 'Finspace',
      technologies: [
        'https://cdn-icons-png.flaticon.com/512/174/174854.png',
        'https://cdn-icons-png.flaticon.com/512/732/732190.png',
    ...
    },
    {
      id: '6',
      image:
        'https://lh3.googleusercontent.com/pw/ADCreHeH-ED58ufjTKfpEvYpPBrQ8PFqG87gPaROCDacipuv4ZA4othOAcYlZGcfKV4s-KleL4PKSIdZ31MiRl-927dUAgguSQkmueIYjkuKUjaTo7mdqm-gzGgltIrfp5nHDe92JRxqJl7HAnzAqaUQW3WP=w957-h663-s-no?authuser=0',
      title: 'Osetr fish',
      technologies: [
        'https://cdn-icons-png.flaticon.com/512/174/174854.png',
        'https://cdn-icons-png.flaticon.com/512/732/732190.png',
